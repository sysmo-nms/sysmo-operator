        ...
        : NFrameContainer(parent)
{
    ...
    selector_group->addButton(dashboard_button, DASHBOARD);
    ...
    stack_layout->insertWidget(MONITOR,   monitor);
    stack_layout->insertWidget(DASHBOARD, dashboard);
    stack->setLayout(stack_layout);

    // Connect stack and selector
    stack_layout->setCurrentIndex(MONITOR);
