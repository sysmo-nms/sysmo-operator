...
class HeadProbeLabel(QFrame):
    def __init__(self, parent, probe):
        ...
        #self.grid.addWidget(QPushButton('Suspend', self), 1,0)
        #self.grid.addWidget(QPushButton('Show properties', self), 2,0)
        #self.grid.addWidget(QPushButton('Advanced setup', self), 3,0)
